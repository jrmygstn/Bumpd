//
//  memoryProfileTV.swift
//  bumpd
//
//  Created by Jeremy Gaston on 8/20/23.
//

import UIKit
import Firebase

class memoryProfileTV: UITableViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "person", for: indexPath) as! memoryTopCVC
    ...
    @IBAction func closeBtnTapped(_ sender: Any) {
        ...
        self.performSegue(withIdentifier: "unwindToMemories", sender: nil)
